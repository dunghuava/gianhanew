                    ...
                    <div class="wrap-form bg">
                        <form id="frmsearch" action="" method="post" accept-charset="utf8">
                            ...
                            <div class="line1">
                                ...
                                <div class="small-item-s">
                                    <button type="button" onclick="_Search();" class="btn btn-search pull-left" style="width:100%;" name="btnSearch">
                                        <i class="fa fa-search">&nbsp;&nbsp;&nbsp;Tìm kiếm</i></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<div id="homepage" class="section is_search">
    <div class="container">
        <div class="row">
            <!--Content  -->
            <div class="col-xs02 col-md-8 nopadding-rgt">
                <div class="block-big">
                    <div class="col-xs02 prl10">
                        <h2 class="title bar"><span>Sàn giao dịch bất động sản</span></h2>
                     </div>
                     <div class="grid">
                        <?php if (!empty($main_realestates)) { ?>
                        <?php foreach ($main_realestates as $real) { ?>
                        <article class="col-xs-6 col-md-6 product p5">
                            <div class="item">
                                ...
                                <div class="col-xs-8 col-md-8 description">
                                    <h3><a class="<?= $real->type_class; ?>" href="<?= $domain.$real->slug_cate.'/'.$real->title_alias.'-'.$real->id;?>" title="<?= $real->title; ?>"><?= strtolower(ucfirst(stripString($real->title,65,'.'))); ?></a></h3>
                                    <div class="cusInfo">
