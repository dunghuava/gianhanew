    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            /*if (empty($getPointType)) {
                ...
                if ($this->total_point > $getPointType->type_point || $this->total_point = $getPointType->type_point) {
            ...
            $url = 'https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyDqAHaMV9ZVcSX992nMQOgZ_Vy80GUZ_8I&address=' . urlencode($this->input->post('txtAddress')) . '&sensor=true';
