<div class="page-header">
      <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Trình đơn <small>trên site</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<?php } ?>
<form action="<?= $root_site.$this->uri->uri_string(); ?>" method="post" enctype="multipart/form-data" id="fMenu_items">
                    ...
                    <div id="required" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <select class="select-search" name="group_id">
                                            ...
                                            ?>
                                            <option value="<?= $menu_group->id; ?>"><?= $menu_group->title; ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="title">Tên đề : <span class="mandatory">*</span>:</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <select class="select-search" id="type_id" name="type_id">
                                            ...
                                            ?>
                                            <option value="<?= $menu_type->id; ?>">|-- <?= $menu_type->title; ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" name="ordering" type="text" value="<?= $this->input->post('ordering'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
