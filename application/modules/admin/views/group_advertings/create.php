...
<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Thêm nhóm
            <small>Thêm mới nhóm adverting</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" rows="5" name="summary" cols="50" id="summary"><?= $this->input->post('summary'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="<?= $root_site.$modules;?>/group_advertings" class="btn btn-info">Hủy</a>
                <input class="btn btn-danger" name="btnCreate" type="submit" onclick="return confirm('Bạn chắc muốn thêm mới nhóm ?')" value="Th&ecirc;m mới" />
            </div>
        </div>
    </div>
    <!-- /Form actions -->
