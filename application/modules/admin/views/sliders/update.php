...
<div class="page-header">
  <div class="page-title text-info text-semibold">
    <h3>
        <span data-icon="&#xe312;"></span> 
        Cập nhật ảnh slider
        <small>Cập nhật một ảnh mới cho slider</small>
    </h3>
</div>
</div>
<!-- /Page header -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="select-search" name="group_id">
                                    ...
                                    ?>
                                    <option value="<?= $sliders_group->id; ?>" <?= ($sliders_group->id == $slide->group_id) ? 'selected' : ''; ?>><?= $sliders_group->title; ?></option>
                                    <?php
                                        }
                                    }
                                    ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="ordering" name="ordering" type="text" value="<?= $slide->ordering; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="params[title]" name="params[title]" type="text" value="<?= json_decode($slide->params)->title; ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="params[content]" name="params[content]" cols="50" rows="10"><?= json_decode($slide->params)->content; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" id="params[readmore]" name="params[readmore]" type="text" value="<?= json_decode($slide->params)->readmore; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="group-inline-input">
                                    <label class="radio-inline">
                                        <input class="styled" <?= $slide->public == 1 ? 'selected' : ''; ?> name="public" type="radio" value="1" id="public"> Có
                                    </label>
                                    <label class="radio-inline">
                                        <input class="styled" <?= $slide->public == 0 ? 'selected' : ''; ?> name="public" type="radio" value="0" id="public"> Không
                                    </label>
                                </div>
                            </div>
                        </div>
