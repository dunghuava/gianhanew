...
<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Thêm mới <small>Thêm mới iên kết nổi bật</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" value="http://" type="text" name="title_alias" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" name="ordering" type="number" value="<?= $this->input->post('ordering') ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
