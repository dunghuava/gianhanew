...
<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
             Nhóm bài viết <small>Danh sách tất cả các nhóm bài viết</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<!-- Callout -->
<script type="text/javascript" src="<?= $root_site; ?>public/admin/js/categories.js"></script>
<!-- Table -->
<div class="panel panel-default">
    <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-list"></i> Nhóm bài viết</h6>
    </div>

    <div class="table-responsive">
        <table class="table table-bordered dataTable" id="categories" component='article'>
            <thead>
                <tr>
