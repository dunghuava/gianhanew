...
<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Nhóm dự án <small>Danh sách tất cả các nhóm dự án</small>
    </h3>
</div>
</div>
<!-- /Page header -->
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h6 class="panel-title"><i class="fa fa-list"></i> Nhóm dự án</h6>
    </div>

    <div class="table-responsive">
        <table class="table table-bordered dataTable" id="categories" component='project'>
            <thead>
                <tr>
