<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Nhóm bất động sản<small>Thêm một nhóm bất động sản mới</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
                        ...
                        <div class="col-xs-8">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="public">Loại bất động sản:</label>
                                        <div class="group-inline-input">
                                            <label class="radio-inline">
                                                <input class="styled" checked name="type_id" type="radio" value="1">Bán
                                            </label>
                                            <label class="radio-inline">
                                                <input class="styled" name="type_id" type="radio" value="2"> Cho thuê
                                            </label>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-actions pull-right">
                <a href="<?= $root_site.$modules.'/category/'; ?>index/realestate" class="btn btn-cancel">Hủy</a>
