...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<?= $root_site.$modules; ?>/streets/index/<?= $this->uri->segment(4).'/'.$this->uri->segment(5) ?>">Quận/huyện</a></li>
                    ...
                    <div id="required" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="title">Tên đường<span class="mandatory">*</span>:</label>
                                        <input class="form-control" name="name" type="text" value="<?= $this->input->post('name'); ?>">
                                    </div>
                                </div>
                            </div>                           
                        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-actions">
                <a href="<?= $root_site.$modules; ?>/streets/index/<?= $this->uri->segment(4).'/'.$this->uri->segment(5) ?>" class="btn btn-danger">Hủy</a>
                <input type="submit" name="btnCreate" value="Thêm mới" class="btn btn-info" />
            </div>
        </div>
    </div>
    <!-- /Form actions -->
