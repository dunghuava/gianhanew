<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            TRANG <small>Cập nhật thông tin trang</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<!-- Form -->
<form method="POST" action="<?= $root_site.$this->uri->uri_string(); ?>" accept-charset="UTF-8" name="fArticles" enctype="multipart/form-data" onsubmit="return confirm('Bạn chắc muốn cập nhật thông tin ?')">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h6 class="panel-title"><i class="fa fa-pencil-square"></i>Cập nhật</h6>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" readonly id="title_alias" name="title_alias" type="text" value="<?= $page['title_alias'];?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="group-inline-input">
                                            <label class="radio-inline">
                                                <input class="styled" <?= $page['public'] == 1 ? 'checked' : ''; ?> name="public" type="radio" value="1" id="public"> Có
                                            </label>
                                            <label class="radio-inline">
                                                <input class="styled" <?= $page['public'] == 0 ? 'checked' : ''; ?> name="public" type="radio" value="0" id="public"> Không
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="content" name="content" cols="50" rows="10"><?= $page['content'];?></textarea>
                                <script type="text/javascript">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="params[meta_title]" value="<?= json_decode($page['params'])->meta_title;?>" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="5" name="params[meta_description]" cols="50" ><?= json_decode($page['params'])->meta_description;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="params[meta_keywords]" value="<?= json_decode($page['params'])->meta_keywords;?>" />
                            </div>
                        </div>
                    </div>
                </div>
