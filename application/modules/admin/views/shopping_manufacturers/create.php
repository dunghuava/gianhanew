...
<div class="page-header">
    <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Thêm nhà sản xuất
            <small>Tạo một thông tin nhà sản xuất mới</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="featured">L&agrave; nh&agrave; sản xuất nổi bật?:</label>
                                <div class="group-inline-input">
                                    <label class="radio-inline">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="7" name="params[meta_description]" cols="50" id="params[meta_description]"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="7" name="params[meta_keywords]" cols="50" id="params[meta_keywords]"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="summary" name="summary" cols="50" rows="10"></textarea>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-actions">
                        ...
                        <input class="btn btn-danger" name="btnCreate" type="submit" value="Th&ecirc;m mới">
                    </div>
                </div>
            </div>
            <!-- /Form actions -->
