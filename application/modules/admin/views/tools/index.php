                    ...
                    <div id="basic-info" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="title">Link<span class="mandatory">*</span>:</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>GET Báo <span class="mandatory">*</span>:</label>
                                        <select class="select-search" name="loai_bao">
                                            <option value="vnexpress" selected="selected">VnExpress.net</option>
                                            <option value="cafeland">Cafeland.vn</option>
                                            <option value="cafef">Cafef.vn</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="group-inline-input">
                                            ...
                                            <label class="radio-inline">
                                                <input class="styled" checked name="featured" type="radio" value="0" id="featured"> Không
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="featured">Tin nóng:</label>
                                        <div class="group-inline-input">
                                            <label class="radio-inline">
                                                <input class="styled" name="is_hot" type="radio" value="1"> Có
                                            </label>
                                            <label class="radio-inline">
                                                <input class="styled" checked name="is_hot" type="radio" value="0"> Không
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="featured">Tiêu điểm:</label>
                                        <div class="group-inline-input">
                                            <label class="radio-inline">
                                                <input class="styled" name="is_focus" type="radio" value="1"> Có
                                            </label>
                                            <label class="radio-inline">
                                                <input class="styled" checked name="is_focus" type="radio" value="0"> Không
                                            </label>
                                        </div>
                                    </div>
                                </div>
