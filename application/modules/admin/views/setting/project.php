...
<div class="page-header">
      <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Cấu hình dự án<small>Cấu hình modules dự án</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<div class="breadcrumb-line">
  <ul class="breadcrumb">
    ...
    <li class="active"> Cấu hình dự án</li>
</ul>
</div>
<!-- /Breadcrumbs line -->
<!-- Callout -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-actions">
                <a href="<?= $root_site.$modules; ?>/settings/reset/project" class="btn btn-info">Khôi phục mặc định</a>
