...
<div class="page-header">
      <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Cấu hình bất động sản<small>Cấu hình modules bất động sản</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<div class="breadcrumb-line">
  <ul class="breadcrumb">
    ...
    <li class="active"> Cấu hình bất động sản</li>
</ul>
</div>
<!-- /Breadcrumbs line -->
<!-- Callout -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-actions">
                <a href="<?= $root_site.$modules; ?>/settings/reset/realestate" class="btn btn-info">Khôi phục mặc định</a>
