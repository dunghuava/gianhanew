...
<div class="page-header">
      <div class="page-title text-info text-semibold">
        <h3>
            <span data-icon="&#xe312;"></span> 
            Cấu hình bài viết<small>Cấu hình modules bài viết</small>
        </h3>
    </div>
</div>
<!-- /Page header -->
...
<div class="breadcrumb-line">
  <ul class="breadcrumb">
    ...
    <li class="active"> Cấu hình bài viết</li>
</ul>
</div>
<!-- /Breadcrumbs line -->
<!-- Callout -->
...
<form action="<?= $root_site.$modules; ?>/settings/edit/article" method="post">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-actions">
                <a href="<?= $root_site; ?>admin/settings/reset/article" class="btn btn-info">Khôi phục mặc định</a>
