 ...
 <div class="page-header">
  <div class="page-title text-info text-semibold">
    <h3>
        <span data-icon="&#xe312;"></span> 
        Cập nhật đơn vị
        <small>Cập nhật thông tin size sản phẩm</small>
    </h3>
</div>
</div>
<!-- /Page header -->
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" id="title" name="title" type="text" value="<?= $size->title; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" id="ordering" name="ordering" type="text" value="<?= $size->ordering; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="summary" name="summary" cols="50" rows="10"><?= $size->summary; ?></textarea>
                    </div>
                </div>
            </div>
