...
$config['mail_smtp_secure']     = 'none'; // default: '' | tls | ssl |
$config['mail_charset']         = 'utf-8';

// Templates Path and optional config
$config['mail_template_folder']  = 'email';
...
$config['mail_user']            = 'forwardmailform@gmail.com';
$config['mail_pass']            = 'ABCabc12';

// Mailer config Sender/Receiver Addresses
$config['mail_admin_mail']      = 'forwardmailform@gmail.com';
$config['mail_admin_name']      = 'ĐĂNG TIN NHÀ ĐẤT';

$config['mail_from_mail']       = 'noreply@dangtinnhadat.net';
$config['mail_from_name']       = 'DANGTINNHADAT.NET';

$config['mail_replyto_mail']    = 'info@dangtinnhadat.net';
$config['mail_replyto_name']    = 'Gửi thư tới';

// BCC and CC Email Addresses
$config['mail_bcc']             = 'someone@example.com';
$config['mail_cc']              = 'fjkdjk';
