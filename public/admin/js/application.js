/* ========================================================
*
* PRMS responsive admin template
*
* ========================================================
*
* File: application.js;
...
================================================== */
	...
	//===== Adding placeholder to all Datatable filter input field =====//
	$('.dataTables_filter input[type=search]').attr('placeholder', 'Từ khóa tìm kiếm');
...
================================================== */
	...
	$('.multi-select').multiselect({
		...
		nonSelectedText: 'Chọn size sản phẩm',
...
================================================== */
	...
	$("#price-amount, #price-amount1").val("$" + $("#range-slider, #range-slider1").slider("values", 0) + " - $" + $("#range-slider, #range-slider1").slider("values", 1));
